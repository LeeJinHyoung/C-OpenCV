...
private:
	...
	static int CallInspFillRectangle(void* lpUserData);
	static int CallInspFillTriangle(void* lpUserData);

	static int CallInspFillDouble(void* lpUserData);


	static int CallOnDetectColor(void* lpUserData);

	int OnInspFillDouble();


	int OnInspFindcontourSample();
	int OnInspFindShapes();
	int OnInspFillCircle();
	int OnInspFillRectangle();
