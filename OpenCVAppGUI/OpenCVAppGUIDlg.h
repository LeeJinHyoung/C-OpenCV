...
private:
	...
	static int CallDeleteNoise(void* lpUserData);
	static int CallInspMorpologyMultiObjects(void* lpUserData);
	static int CallInspDrawHistpogram(void* lpUserData);
	...
	static int CallInspMSearchingContour(void* lpUserData);
	...
	int OnInspDrawHistpogram();
	int OnInspHistoEqulization();
	int OnInspGamma();
	int OnInspCorrection();
	int OnDrawHistogram(const Mat& src_gray, Mat& draw_color);
	int OnInspSearchingContour();
	int OnInspMSearchingContour();
	int OnInspMatching();
